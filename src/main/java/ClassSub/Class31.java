...
public class Class31 implements Class232
{
    ...
    public ByteBuffer imageToByteBuffer(final BufferedImage bufferedImage, final boolean b, final boolean b2, final int[] array) {
        ...
        if (b3) {
            this.depth = 32;
            bufferedImage2 = new BufferedImage(Class31.glAlphaColorModel, Raster.createInterleavedRaster(0, i, j, 4, null), false, new Hashtable<Object, Object>());
        }
        else {
            this.depth = 24;
            bufferedImage2 = new BufferedImage(Class31.glColorModel, Raster.createInterleavedRaster(0, i, j, 3, null), false, new Hashtable<Object, Object>());
        }
        ...
        final byte[] array2 = (byte[])((DataBufferByte)bufferedImage2.getRaster().getDataBuffer()).getData();
        if (array != null) {
