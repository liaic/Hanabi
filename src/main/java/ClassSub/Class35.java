...
public class Class35 extends RuntimeException
{
    ...
    public Class35(final String s) {
        this(s, null, -1, null, -1);
    }
    
    public Class35(final String message, final String filename, final int lineno, final String source, final int tokenIndex) {
        super(message);
        this.message = null;
        this.filename = null;
        this.lineno = -1;
    ...
    public Class35(final int wrappedExceptionType, final Object wrappedException) {
        this();
