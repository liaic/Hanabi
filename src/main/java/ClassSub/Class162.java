...
public class Class162 extends Class115
{
    ...
    public Class162(final float n, final float n2, final float n3, final float n4, final float n5) {
        this(n, n2, n3, n4, n5, 25);
    }
    
    public Class162(final float n, final float n2, final float n3, final float n4, final float n5, final int n6) {
        this(n, n2, n3, n4, n5, n6, 15);
    }
    
    public Class162(final float x, final float y, final float width, final float height, final float cornerRadius, final int segmentCount, final int cornerFlags) {
    ...
    private List createPoints(final int n, final float n2, final float n3, final float n4, final float n5, final float n6) {
        ...
        for (float n8 = n5; n8 <= n6 + n7; n8 += n7) {
            ...
            final float n10 = (float)(n3 + Class165.cos(Math.toRadians((double)n9)) * n2);
            final float n11 = (float)(n4 + Class165.sin(Math.toRadians((double)n9)) * n2);
