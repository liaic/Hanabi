...
public class Class248
{
    ...
    public Class248(@NotNull final String s) {
        super();
    ...
    @NotNull
    public Class248 uniform1i(@NotNull final String s, final int n) {
        GL20.glUniform1i(GL20.glGetUniformLocation(this.program, (CharSequence)s), n);
        return this;
    }
    
    @NotNull
    public Class248 uniform2i(@NotNull final String s, final int n, final int n2) {
        GL20.glUniform2i(GL20.glGetUniformLocation(this.program, (CharSequence)s), n, n2);
        return this;
    }
    
    @NotNull
    public Class248 uniform3i(@NotNull final String s, final int n, final int n2, final int n3) {
        GL20.glUniform3i(GL20.glGetUniformLocation(this.program, (CharSequence)s), n, n2, n3);
        return this;
    }
    
    @NotNull
    public Class248 uniform4i(@NotNull final String s, final int n, final int n2, final int n3, final int n4) {
        GL20.glUniform4i(GL20.glGetUniformLocation(this.program, (CharSequence)s), n, n2, n3, n4);
        return this;
    }
    
    @NotNull
    public Class248 uniform1f(@NotNull final String s, final float n) {
        GL20.glUniform1f(GL20.glGetUniformLocation(this.program, (CharSequence)s), n);
        return this;
    }
    
    @NotNull
    public Class248 uniform2f(@NotNull final String s, final float n, final float n2) {
        GL20.glUniform2f(GL20.glGetUniformLocation(this.program, (CharSequence)s), n, n2);
        return this;
    }
    
    @NotNull
    public Class248 uniform3f(@NotNull final String s, final float n, final float n2, final float n3) {
        GL20.glUniform3f(GL20.glGetUniformLocation(this.program, (CharSequence)s), n, n2, n3);
        return this;
    }
    
    @NotNull
    public Class248 uniform4f(@NotNull final String s, final float n, final float n2, final float n3, final float n4) {
        GL20.glUniform4f(GL20.glGetUniformLocation(this.program, (CharSequence)s), n, n2, n3, n4);
        return this;
    }
    
    @NotNull
    public Class248 uniform1b(@NotNull final String s, final boolean b) {
    ...
    public void addDefaultUniforms() {
        ...
        GL20.glUniform1f(GL20.glGetUniformLocation(this.program, (CharSequence)"time"), (float)(System.currentTimeMillis() - this.startTime) / 1000.0f);
    }
}
