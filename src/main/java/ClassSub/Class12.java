...
public interface Class12
{
    ...
    public static final boolean 所以请你滚蛋吧你可以否认你没有文化的事实那么请你拿出实力当然你可以继续用你那支离破碎的语言和不要脸的功夫继续和我对话你那破烂程序能打出象样的华丽唠嗑吗看着你现在的词语逻辑混乱不堪你不觉得害臊吗NMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSLNMSL  ;
