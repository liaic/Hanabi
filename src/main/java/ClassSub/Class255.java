...
{
    public static Class236 ALPHA;
    public static Class236 LUMINANCE;
    public static Class236 LUMINANCE_ALPHA;
    public static Class236 RGB;
    public static Class236 RGBA;
    public static Class236 BGRA;
    public static Class236 ABGR;
    ...
    public Class255(final InputStream input) throws IOException {
        super();
        this.input = input;
        this.crc = new CRC32();
        this.readFully(this.buffer = new byte[4096], 0, Class255.SIGNATURE.length);
    ...
    public Class236 decideTextureFormat(final Class236 class236) {
        switch (this.colorType) {
            case 2: {
                if (class236 == Class255.ABGR || class236 == Class255.RGBA || class236 == Class255.BGRA || class236 == Class255.RGB) {
                    return class236;
                }
                return Class255.RGB;
            }
            case 6: {
                ...
                return Class255.RGBA;
            }
            case 0: {
                if (class236 == Class255.LUMINANCE || class236 == Class255.ALPHA) {
                    return class236;
                }
                return Class255.LUMINANCE;
            }
            case 4: {
                return Class255.LUMINANCE_ALPHA;
            }
            case 3: {
                if (class236 == Class255.ABGR || class236 == Class255.RGBA || class236 == Class255.BGRA) {
                    return class236;
                }
                return Class255.RGBA;
            }
    ...
    public void decode(final ByteBuffer byteBuffer, final int n, final Class236 class236) throws IOException {
        ...
        try {
            for (int i = 0; i < this.height; ++i) {
                ...
                switch (this.colorType) {
                    ...
                    case 4: {
                        if (class236 == Class255.LUMINANCE_ALPHA) {
                            this.copy(byteBuffer, array);
                            break;
                        }
                        throw new UnsupportedOperationException("Unsupported format for this image");
    ...
    private static boolean checkSignature(final byte[] array) {
        for (int i = 0; i < Class255.SIGNATURE.length; ++i) {
            if (array[i] != Class255.SIGNATURE[i]) {
                return false;
            }
        }
        return true;
    ...
    static {
        Class255.ALPHA = new Class236(1, true, null);
        Class255.LUMINANCE = new Class236(1, false, null);
        Class255.LUMINANCE_ALPHA = new Class236(2, true, null);
        Class255.RGB = new Class236(3, false, null);
        Class255.RGBA = new Class236(4, true, null);
        Class255.BGRA = new Class236(4, true, null);
        Class255.ABGR = new Class236(4, true, null);
