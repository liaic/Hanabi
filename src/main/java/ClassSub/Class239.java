...
public class Class239 implements Class247
{
    ...
    public Class239() {
        ...
        this.GL = Class83.get();
        this.width = 1.0f;
        this.def = new Class63();
        this.lineCaps = false;
        this.points = new float[Class239.MAX_POINTS * 2];
        this.colours = new float[Class239.MAX_POINTS * 4];
    }
    ...
    public void start() {
        ...
        this.cpt = 0;
        this.GL.flush();
        final float[] array = (float[])this.GL.getCurrentColor();
    ...
    public void renderLinesImpl(final float[] array, final int n, final float n2) {
        ...
        this.GL.glEnd();
        final float n23 = (n3 <= 12.5f) ? 5.0f : (180.0f / (float)Math.ceil((double)n3 / 2.5));
        if (this.lineCaps) {
            final float n24 = array[2] - array[0];
            final float n25 = array[3] - array[1];
            final float n26 = (float)Math.toDegrees(Math.atan2((double)n25, (double)n24)) + 90.0f;
            if (n24 != 0.0f || n25 != 0.0f) {
                this.GL.glBegin(6);
                this.bindColor(0);
                this.GL.glVertex2f(array[0], array[1]);
                for (int n27 = 0; n27 < 180.0f + n23; n27 += n23) {
        ...
        if (this.lineCaps) {
            ...
            final float n31 = (float)Math.toDegrees(Math.atan2((double)n30, (double)n29)) - 90.0f;
            if (n29 != 0.0f || n30 != 0.0f) {
                this.GL.glBegin(6);
                this.bindColor(n - 1);
                this.GL.glVertex2f(array[n * 2 - 2], array[n * 2 - 1]);
                for (int n32 = 0; n32 < 180.0f + n23; n32 += n23) {
