...
public class Class3 extends Class179<Value>
{
    ...
    public Class3(final Value value) {
        super(-1, -1, 0, 0, value);
    ...
    public void draw() {
        ...
        int n = 0;
        if (this.isSelected) {
            final String[] array = (String[])((Value)this.value).getModes();
            for (int i = 0; i < array.length - 1; ++i) {
                n += this.fontRenderer.field_78288_b + 2;
            }
            n += 2;
        }
        Class167.setColor(Class8.PANEL_SECONDARY_COLOR);
        GL11.glLineWidth(2.0f);
        Class167.drawRect(2, 0, 0, rectangle.width, rectangle.height + n, Class8.PANEL_SECONDARY_COLOR.getRGB());
        Class167.setColor(Class8.PANEL_MAIN_COLOR);
        Gui.func_73734_a(0, 0, rectangle.width, rectangle.height + n, Class167.toRGBA(Class8.PANEL_MAIN_COLOR));
        ...
        if (rectangle.contains(calculateMouseLocation)) {
            ...
            final String[] array2 = (String[])((Value)this.value).getModes();
            for (int j = 0; j < array2.length; ++j) {
                if (j != this.getSelectedIndex()) {
                    int n2 = this.fontRenderer.field_78288_b + 2;
                    Label_0444: {
                        Label_0441: {
                    ...
                    if (calculateMouseLocation.y >= rectangle.y + height && calculateMouseLocation.y <= rectangle.y + height + n2) {
                        Gui.func_73734_a(0, height, rectangle.width, rectangle.height + height - 1, Class167.toRGBA(new Color(0, 0, 0, Mouse.isButtonDown(0) ? 125 : 70)));
                        break;
                    }
                    height += n2;
                }
        ...
        this.fontRenderer.func_78276_b(((String[])((Value)this.value).getModes())[((Value)this.value).getCurrentMode()], 2, rectangle.height / 2 - this.fontRenderer.field_78288_b / 2, Class167.toRGBA(Color.white));
        if (this.isSelected) {
            int n3 = rectangle.height + 2;
            final String[] array3 = (String[])((Value)this.value).getModes();
            for (int k = 0; k < array3.length; ++k) {
                if (k != this.getSelectedIndex()) {
                    Class167.setColor(Color.white);
                    this.fontRenderer.func_78276_b(array3[k], 2, n3, Class167.toRGBA(Color.white));
                    n3 += this.fontRenderer.field_78288_b + 2;
                }
            }
        }
        GL11.glEnable(2884);
    ...
    public void update() {
        ...
        for (int length = array.length, i = 0; i < length; ++i) {
            max = Math.max(max, this.fontRenderer.func_78256_a(array[i]));
        }
        this.width = max + 8 + this.fontRenderer.field_78288_b;
        super.width = max + 12 + this.fontRenderer.field_78288_b;
        if (this.isSelected) {
            super.height = 0;
            for (final String s : (String[])((Value)this.value).getModes()) {
                this.height += this.fontRenderer.field_78288_b + 2;
            }
            super.height = this.height;
        }
        else {
            super.height = this.fontRenderer.field_78288_b + 4;
        }
        this.height = this.fontRenderer.field_78288_b + 4;
    }
        ...
        if (point.x <= rectangle.getWidth() + this.getX() && this.isSelected) {
            ...
            for (int i = 0; i < array.length; ++i) {
                if (i != this.getSelectedIndex()) {
                    if (point.y >= n4 && point.y <= n4 + this.fontRenderer.field_78288_b) {
                        ((Value)this.value).setCurrentMode(i);
                        this.isSelected = false;
                        break;
                    }
                    n4 += this.fontRenderer.field_78288_b + 2;
                }
            }
            return true;
        }
