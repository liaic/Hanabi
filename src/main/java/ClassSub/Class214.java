...
public class Class214 implements Class42
{
    static final float EPSILON = 1.0E-6f;
    private float[] pointsX;
    private float[] pointsY;
    private int numPoints;
    private Class113[] edges;
    private int[] V;
    private int numEdges;
    private Class166[] triangles;
    ...
    public Class214() {
        ...
        this.numPoints = 0;
        this.edges = new Class113[100];
        this.numEdges = 0;
        this.triangles = new Class166[100];
        this.numTriangles = 0;
    }
    ...
    private void addEdge(final int n, final int n2, final int n3) {
        ...
        if (edge < 0) {
            if (this.numEdges == this.edges.length) {
                final Class113[] edges = new Class113[this.edges.length * 2];
            ...
            final Class113[] edges2 = this.edges;
            final int n5 = n4;
        ...
        class114.t0 = t0;
        class114.t1 = t2;
        class114.suspect = true;
    }
    
    private void deleteEdge(final int n, final int n2) throws Class237 {
        final int edge;
        if (0 > (edge = this.findEdge(n, n2))) {
            throw new Class237("Attempt to delete unknown edge");
        }
        final Class113[] edges = this.edges;
        final int n3 = edge;
        final Class113[] edges2 = this.edges;
    ...
    void markSuspect(final int n, final int n2, final boolean suspect) throws Class237 {
        final int edge;
        if (0 > (edge = this.findEdge(n, n2))) {
            throw new Class237("Attempt to mark unknown edge");
        }
        this.edges[edge].suspect = suspect;
    }
    
    private Class113 chooseSuspect() {
        for (int i = 0; i < this.numEdges; ++i) {
            final Class113 class113 = this.edges[i];
            if (class113.suspect) {
                class113.suspect = false;
                if (class113.t0 >= 0 && class113.t1 >= 0) {
                    return class113;
                }
            }
        }
    ...
    public void basicTriangulation() throws Class237 {
        ...
        while (i > 2) {
            if (0 >= n--) {
                throw new Class237("Bad polygon");
            }
            int n3 = n2;
            if (i <= n3) {
                n3 = 0;
            ...
            if (this.numTriangles == this.triangles.length) {
                final Class166[] triangles = new Class166[this.triangles.length * 2];
                System.arraycopy(this.triangles, 0, triangles, 0, this.numTriangles);
                this.triangles = triangles;
            }
            this.triangles[this.numTriangles] = new Class166(n5, n6, n7);
    ...
    private void optimize() throws Class237 {
        Class113 chooseSuspect;
        while ((chooseSuspect = this.chooseSuspect()) != null) {
            ...
            if (-1 == n || -1 == n2) {
                throw new Class237("can't find quad");
            }
            ...
            if (0.0f > rho || 0.0f > rho2) {
                throw new Class237("original triangles backwards");
            }
