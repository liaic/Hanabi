...
public class Class313 implements Class42
{
    private float[][] triangles;
    public static final boolean Cracked_By_Somebody_Dumped_BY_Ganga_SupportedbySucen;
    
    public Class313(final Class42 class42) {
        super();
        this.triangles = new float[class42.getTriangleCount() * 6 * 3][2];
        int n = 0;
        for (int i = 0; i < class42.getTriangleCount(); ++i) {
            float n2 = 0.0f;
            float n3 = 0.0f;
            for (int j = 0; j < 3; ++j) {
                final float[] array = (float[])class42.getTrianglePoint(i, j);
                n2 += array[0];
                n3 += array[1];
            }
            ...
            for (int k = 0; k < 3; ++k) {
                ...
                final float[] array2 = (float[])class42.getTrianglePoint(i, k);
                final float[] array3 = (float[])class42.getTrianglePoint(i, n6);
            ...
            for (int l = 0; l < 3; ++l) {
                ...
                final float[] array4 = (float[])class42.getTrianglePoint(i, l);
                final float[] array5 = (float[])class42.getTrianglePoint(i, n7);
